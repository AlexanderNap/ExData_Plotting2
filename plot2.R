...
plot(BaltimorePMbyYears, type="l", ylab = expression("Emissions of PM"[2.5]* ", tons"), main = expression("Variation of PM"[2.5]*" in the Baltimore City, Maryland , 1999-2008"), col="red")
